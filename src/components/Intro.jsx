  ...
  return (
    <div>
      <div className="intro-wrapper">
        ...
        <div>
          <p className="div-width center">Soy desarrolladora Full-Stack junior con experiencia previa en relaciones con  clientes, así como en el ámbito de la comunicación y redes sociales. 
        ...
        <div className="div-width">
          ...
          <a href= "https://www.linkedin.com/in/marta-escribano-garcia">Linkedin</a>
          </div>
          <div className="div-contact">
